...
var Table = (function(){
	...
	var table = {
		...
		SortedAscendingClassName:"fa fa-sort-up",
		SortedDescendingClassName:"fa fa-sort-down",
		SortClassName:"fa fa-sort",
	...
	table.autosort = function(t,args) {
		...
		this.processTableCells(t, "THEAD", function(c) {
			...
			if (type!=null) {
				...
				c.innerHTML = '<i class="'+table.SortClassName+'"></i>&nbsp;' + c.innerHTML;
